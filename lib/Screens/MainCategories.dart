...
import '../widgets/FavouriteIcon.dart';
...
class MainCategories extends StatefulWidget {
  ...
  MainCategories(this.subCategory, this.showFavs);
...
class _MainCategoriesState extends State<MainCategories> {
  ...
  Widget build(BuildContext context) {
    final productsData = Provider.of<Products>(context, listen: true)
        .items
        .where((prodItem) =>
            prodItem.subCategory.toLowerCase() ==
    ...
    return Scaffold(
        ...
        actions: <Widget>[
          Builder(
            builder: (context) => IconButton(
              ...
              onPressed: () async {
                await showSearch(context: context, delegate: ProductSearch());
              },
            ),
          ),
        ],
      ...
      body: GridView.builder(
        ...
        itemBuilder: (ctx, i) => ChangeNotifierProvider.value(
          value: products[i],
          child: Container(
            decoration: Theme.of(context).backgroundColor == Color(0xFF111111)
                ? null
                : BoxDecoration(
                    boxShadow: [
                      BoxShadow(
