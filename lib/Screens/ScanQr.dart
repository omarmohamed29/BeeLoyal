  ...
  Future scan() async {
    ...
    try {
      ...
      if(barcode.contains('BeelQR01474774658')){
        ...
        final points = pointsInWallet + int.parse(barcode.replaceAll('BeelQR01474774658', ''));
        final pointUpdater = Provider.of<GetPoints>(context, listen: false);
        await pointUpdater.scanForPoints(int.parse(barcode.replaceAll('BeelQR01474774658', '')));
